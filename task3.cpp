...
void test_comparisons() {
    ofstream compFile("comparisons.csv"), timeFile("times.csv");

    compFile << "Array Type,Array Size,Bubble,Selection,Insertion,Heap\n";
    timeFile << "Array Type,Array Size,Bubble,Selection,Insertion,Heap\n";
    ...
    for (int size = 1; size <= 30; ++size) {
        ...
        compFile << "Random," << size << "," << comparisons[0] << "," << comparisons[1] << "," << comparisons[2] << "," << comparisons[3] << endl;
        timeFile << "Random," << size << "," << times[0] << "," << times[1] << "," << times[2] << "," << times[3] << endl;
    }
    ...
    for (int size = 1; size <= 30; ++size) {
        ...
        compFile << "Sorted," << size << "," << comparisons[0] << "," << comparisons[1] << "," << comparisons[2] << "," << comparisons[3] << endl;
        timeFile << "Sorted," << size << "," << times[0] << "," << times[1] << "," << times[2] << "," << times[3] << endl;
    }
    ...
    for (int size = 1; size <= 30; ++size) {
        ...
        compFile << "Inversely Sorted," << size << "," << comparisons[0] << "," << comparisons[1] << "," << comparisons[2] << "," << comparisons[3] << endl;
        timeFile << "Inversely Sorted," << size << "," << times[0] << "," << times[1] << "," << times[2] << "," << times[3] << endl;
    }
